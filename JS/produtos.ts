...
const produto___whey__WOLFFIT = new Product(
  1,
  "WHEY PROTEIN WOLFFIT",
  70.99,
  ...
  produto___WHEY__configuracoes.sabores,
  produto___WHEY__configuracoes.gramas
);
const produto___creatina__WOLFFIT = new Product(
  2,
  "CREATINA WOLF FIT - 300G",
  49.99,
  "A creatina é uma molécula encontrada naturalmente no tecido muscular, em quantidade limitada, que participa de todos os processos energéticos do corpo. Ela é fundamental na contração muscular, proporcionando maior força muscular, resistência física, redução no tempo de recuperação, e aumento do volume muscular.",
  "Natural",
  "300G"
);

const creatina__wolffit = {
  nome: document.getElementById("creatina__wolffit_h5") as HTMLInputElement,
  descricao: document.getElementById("creatina__wolffit_p") as HTMLInputElement,
  buton: document.getElementById(
    "creatina__wolffit__buton"
  ) as HTMLInputElement,
  tipo: produto___creatina__WOLFFIT,
};
const whey__wolffit = {
  nome: document.getElementById("whey__wolffit_h5") as HTMLInputElement,
  descricao: document.getElementById("whey__wolffit_p") as HTMLInputElement,
  buton: document.getElementById("whey__wolffit__buton") as HTMLInputElement,
...
for (
  ...
  if (prod != null) {
    const itens = document.getElementById("itens") as HTMLInputElement;
...
const total_ = document.getElementById("total") as HTMLInputElement;
