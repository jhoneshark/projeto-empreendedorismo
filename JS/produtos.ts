...
class Product {
    ...
    constructor(id: number, name: string, value: number, description: string, sabor?: string, gramas?: string) {
        this.id = id;
        this.name = name;
        this.value = value;
...
const creatina__wolffit ={ 
    ...
    buton: document.getElementById("creatina__wolffit__buton") as HTMLInputElement,
...
function showProduct ({nome, descricao, tipo}: {nome: any, descricao: any, tipo: Product} ) 
{
...
function apertouBotao( {valor, qtd, nome, descricao, buton, tipo}: {qtd: number, valor: number, nome: any, descricao: any,buton: any, tipo: Product} ) {
